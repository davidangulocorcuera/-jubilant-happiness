...
class DrawerItem(var icon: Int = 0, var text: String? = "",
    ...
    companion object {
        fun addMenuOptions(menuOptions: ArrayList<DrawerItem>): ArrayList<DrawerItem> {
            ...
            menuOptions.add(DrawerItem(R.drawable.ic_contact, "Contact us", isClickable = true,isSeparator = true, type = DrawerViewModel.MenuItemType.CONTACT))
            menuOptions.add(DrawerItem(R.drawable.ic_exit, "Close session", isClickable = true,isSeparator = false, type = DrawerViewModel.MenuItemType.LOG_OUT))
            return menuOptions
